...
function Success() {
  ...
  return (
    <section className="success">
      <h1 className="title">Thank you for using the<br/> CFMO Venue Reservation Portal!</h1>
      <p className="body">Your reservation has been requested with the following details:</p>
