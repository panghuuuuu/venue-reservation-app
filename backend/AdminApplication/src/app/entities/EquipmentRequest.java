...
public class EquipmentRequest {
	...
	public String toString() {
		return "EquipmentRequest [equipmentID=" + equipmentID + ", reservationID=" + reservationID + ", tables="
				+ tables + ", chairs=" + chairs + ", extensions=" + extensions + ", projectors=" + projectors
				+ ", projectorScreens=" + projectorScreens + ", microphones=" + microphones + ", speakers=" + speakers
				+ "]";
	}
